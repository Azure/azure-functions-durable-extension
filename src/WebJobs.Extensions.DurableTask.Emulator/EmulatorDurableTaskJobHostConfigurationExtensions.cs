...
namespace Microsoft.Azure.WebJobs.Extensions.DurableTask
{
    ...
    /// </summary>
    public static class EmulatorDurableTaskJobHostConfigurationExtensions
    {
#if NETSTANDARD2_0
        /// <summary>
        ...
        public static IWebJobsBuilder AddEmulatorDurableTask(this IWebJobsBuilder builder)
        {
            if (builder == null)
            {
            ...
            builder.AddExtension<DurableTaskExtensionEmulatorConfig>()
                .BindOptions<DurableTaskEmulatorOptions>()
                .Services.AddSingleton<IOrchestrationServiceFactory, EmulatorOrchestrationServiceFactory>()
        ...
        /// <returns>Returns the provided <see cref="IWebJobsBuilder"/>.</returns>
        public static IWebJobsBuilder AddEmulatorDurableTask(this IWebJobsBuilder builder, IOptions<DurableTaskEmulatorOptions> options)
        {
            if (builder == null)
            {
                throw new ArgumentNullException(nameof(builder));
        ...
        public static void Use(
            ...
            DurableTaskExtensionEmulatorConfig listenerConfig)
        {
            if (hostConfig == null)
            {
