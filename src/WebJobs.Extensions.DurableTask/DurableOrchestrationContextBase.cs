...
{
    /// <summary>
    /// Abstract class for parameter data for orchestration bindings that can be used to schedule function-based activities.
    /// </summary>
    public abstract class DurableOrchestrationContextBase
    {
        ...
        protected readonly Dictionary<string, object> pendingExternalEvents =
            new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);

        protected readonly DurableTaskExtension config;
        protected readonly string orchestrationName;
        protected readonly string orchestrationVersion;

        protected OrchestrationContext innerContext;
        protected string serializedInput;
        protected string serializedOutput;
        protected int owningThreadId;

        internal DurableOrchestrationContextBase(
