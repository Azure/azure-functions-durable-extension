...
namespace Microsoft.Azure.WebJobs.Extensions.DurableTask
{
    internal class EndToEndTraceHelper
    {
        ...
        private readonly DurableTaskExtension durableTaskExtension;

        private long sequenceNumber;

        public EndToEndTraceHelper(JobHostConfiguration config, ILogger logger, DurableTaskExtension durableTaskExtension)
        {
            this.logger = logger ?? throw new ArgumentNullException(nameof(logger));
            this.durableTaskExtension = durableTaskExtension;
        }
...
#pragma warning disable SA1117 // Parameters should be on same line or separate lines
            ...
            bool isReplay)
        {
            ...
            if (this.ShouldReplayEventsBeLogged(isReplay))
            {
            ...
            string reason)
        {
            ...
            if (this.ShouldReplayEventsBeLogged(isReplay: false))
            {
