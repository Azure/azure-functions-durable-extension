...
{
    /// <summary>
    /// Abstract class for client for starting, querying, terminating, and raising events to new or existing orchestration instances.
    /// </summary>
    public abstract class DurableOrchestrationClientBase
    {
        ...
        internal DurableOrchestrationClientBase(
