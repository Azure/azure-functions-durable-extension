...
namespace Microsoft.Azure.WebJobs
{
    ...
    public abstract class DurableOrchestrationClientBase
    {
        ...
        /// <param name="showHistoryInputOutput">Boolean marker for including input and output in the execution history response.</param>
        /// <returns>Returns a task which completes when the status has been fetched.</returns>
        public abstract Task<DurableOrchestrationStatus> GetStatusAsync(string instanceId, bool showHistory = false, bool showHistoryInputOutput = false);
    }
}
