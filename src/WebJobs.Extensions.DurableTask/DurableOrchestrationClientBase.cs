...
namespace Microsoft.Azure.WebJobs
{
    ...
    public abstract class DurableOrchestrationClientBase
    {
        ...
        {
            return this.GetStatusAsync(instanceId, showHistory, showHistoryOutput: false, fetchInput: true);
        }
        ...
        /// <returns>Returns a task which completes when the status has been fetched.</returns>
        public abstract Task<DurableOrchestrationStatus> GetStatusAsync(string instanceId, bool showHistory, bool showHistoryOutput, bool fetchInput = true);
