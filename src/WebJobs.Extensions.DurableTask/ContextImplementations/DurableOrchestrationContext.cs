...
#pragma warning restore 618
    {
        ...
        /// <summary>
        /// Structured failure details supplied by an out-of-proc worker (e.g. the durable-functions
        /// JS SDK) when an uncaught sub-orchestration or activity failure propagates out of the
