...
namespace Microsoft.Azure.WebJobs.Extensions.DurableTask
{
    ...
    internal class SystemEnvironment
    {
        ...
        {
            return !IsAppService() && !string.IsNullOrEmpty(ContainerName);
        }
        ...
        public static bool IsLinuxDedicated()
        {
            return IsAppService() && !string.IsNullOrEmpty(FunctionsLogsMountPath);
        }
