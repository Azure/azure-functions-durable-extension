...
{
    public class TestEntityWithDependencyInjectionHelpers
    {
        ...
        [FunctionName(nameof(EnvironmentOrchestration))]
        public async Task<string> EnvironmentOrchestration([OrchestrationTrigger] IDurableOrchestrationContext ctx)
        {
        ...
        [FunctionName(nameof(BlobEnvironmentOrchestration))]
        public async Task<List<string>> BlobEnvironmentOrchestration([OrchestrationTrigger] IDurableOrchestrationContext ctx)
        {
