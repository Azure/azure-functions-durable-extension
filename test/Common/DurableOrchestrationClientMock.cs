...
namespace Microsoft.Azure.WebJobs.Extensions.DurableTask.Tests
{
    internal class DurableOrchestrationClientMock : DurableOrchestrationClient
    {
        ...
        public override Task<DurableOrchestrationStatus> GetStatusAsync(string instanceId, bool showHistory = false, bool showHistoryOutput = false, bool hideInput = false)
        {
