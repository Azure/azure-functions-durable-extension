        ...
        private static List<string> GetLogs_Activity_Gets_HttpManagementPayload(string instanceId, string[] functionNames, bool extendedSessions)
        {
            ...
            if (extendedSessions)
            {
                list = new List<string>()
                {
                    ...
                    $"{instanceId}: Function '{functionNames[1]} ({FunctionType.Activity})' started. IsReplay: False. Input: [{{\"$type\":\"Microsoft.Azure.WebJobs.Extensions.DurableTask.HttpManagementPayload, Microsoft.Azure.WebJobs.Extensions.DurableTask\",\"id\":\"{instanceId}\",\"statusQueryGetUri\":\"{TestConstants.NotificationUrlBase}/instances/{instanceId}?taskHub={taskHubName}&connection=Storage&code=mykey\",\"sendEventPostUri\":\"{TestConstants.NotificationUrlBase}/instances/{instanceId}/raiseEvent/{{eventName}}?taskHub={taskHubName}&connection=Storage&code=mykey\",\"terminatePostUri\":\"{TestConstants.NotificationUrlBase}/instances/{instanceId}/terminate?reason={{text}}&taskHub={taskHubName}&connection=Storage&code=mykey\"}}]. State: Started. HubName: {taskHubName}. AppName: . SlotName: . ExtensionVersion: 1.4.1.0. SequenceNumber: 4.",
