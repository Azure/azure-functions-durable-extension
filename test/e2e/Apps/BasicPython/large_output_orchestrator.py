...
def large_output_orchestrator(context: DurableOrchestrationContext):
...
async def start_large_output_orchestrator(req: func.HttpRequest, client) -> func.HttpResponse:
...
@bp.durable_client_input(client_name="client")
async def query_large_output(req: func.HttpRequest, client) -> func.HttpResponse:
