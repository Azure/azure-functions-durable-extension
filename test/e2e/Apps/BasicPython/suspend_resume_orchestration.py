...
async def suspend_instance(req: func.HttpRequest, client: df.DurableOrchestrationClient, context: func.Context):
...
@bp.durable_client_input(client_name="client")
async def resume_instance(req: func.HttpRequest, client: df.DurableOrchestrationClient, context: func.Context):
    instance_id = req.params.get("instanceId")
