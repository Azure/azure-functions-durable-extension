...
internal class IsolatedTestLanguageLocalizer : ITestLanguageLocalizer
{
    private readonly Dictionary<string, string> isolatedLocalizedStrings = new Dictionary<string, string>
    {
        ...
        { "RestartInvalidInstance.ErrorName", "NotFound" },
        { "RestartInvalidInstance.ErrorMessage", "ArgumentException: An orchestration with the instanceId '{0}' was not found." },
        { "RestartRunningInstance.ErrorName", "FailedPrecondition" },
        { "RestartRunningInstance.ErrorMessage", "InvalidOperationException: An orchestration with the instanceId {0} cannot be restarted." },
    };
